...
Notes:
  ...
  - Always force-updates all deployed probes to the same worker build.
...
TOTAL_STEPS=4
[[ -n "$NOTIFY_TOPIC_ARN" ]] && TOTAL_STEPS=5
CURRENT_STEP=1
